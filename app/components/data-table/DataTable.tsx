...
function RowLink(props: RowLinkProps) {
  ...
  const { isActive, isLoading, children, ...rest } = props;
    ...
    return (
      <TableRow isLoading={isLoading} isLinkRow {...rest}>
        <>
          ...
          <RemixLink to={"/"} style={{textDecoration:"none", color:"black"}}>
            <A />
          </RemixLink>
          {/* </NextLink> */}
          {children}
...
const skeletonData = new Array(20).fill("111");
