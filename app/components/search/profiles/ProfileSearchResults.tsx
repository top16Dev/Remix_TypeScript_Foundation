...
// const ProfileSearchResults = connectInfiniteHits((props): JSX.Element => {
function ProfileSearchResults(props: any){
  ...
  return (
    <Box css={{ paddingBottom: '$8' }}>
      <ResultsGrid>
        {/* {hits.map((hit, index) => ( */}
          <CreatorCard key={1} creator={hit[0]} />
        {/* ))} */}
      </ResultsGrid>
